...
The file upload functionality has been moved directly into streamlit_app.py.
...
def process_and_visualize_track_data(artist_monthly_listeners_df=None, catalog_file_data=None, audience_geography_data=None, ownership_data=None):
    """Process and visualize track data with all the necessary analysis and visualization
    ...
    mldr = None  # Initialize mldr as None
    if artist_monthly_listeners_df is not None:
    ...
    if st.button('Run All'):
        ...
        listener_geography_df, listener_percentage_usa = process_audience_geography(audience_geography_data)
        ...
        ownership_df = process_ownership_data(ownership_data, track_names)
