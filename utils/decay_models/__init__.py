...
4. Generate future forecasts with forecasting.forecast_values()
...
```python
from utils.decay_models import remove_anomalies, fit_decay_curve, update_fitted_params, forecast_values
...
# Generate forecasts
forecasts = forecast_values(params_df, initial_value, start_period, periods)
```
"""
